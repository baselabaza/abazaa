--[[
الالعاب ل سورس بيتٲ
تم تعديل الملف واضافه الالعاب من قبل بــاســل اباظه ᐂ (@𝑋𝐵_0𝐵)
--]]
...
if not redis:get(bita..'lock_geams'..msg.chat_id_) then 
return "• ** أهلا عزيزي "..msg.TheRankCmd.."\n• ** الالعاب بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(bita..'lock_geams'..msg.chat_id_) 
return "• ** أهلا عزيزي "..msg.TheRankCmd.."\n• ** تم تفعيل الالعاب \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "الالعاب" or MsgText[2] == "اللعبه" or MsgText[2] == "اللعبة" then
if not msg.Admin then return "• ** هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(bita..'lock_geams'..msg.chat_id_) then 
return "• ** أهلا عزيزي "..msg.TheRankCmd.."\n• ** الالعاب بالتأكيد معطله\n✓" 
else
redis:set(bita..'lock_geams'..msg.chat_id_,true)  
return "• ** أهلا عزيزي "..msg.TheRankCmd.."\n• ** تم تعطيل الالعاب\n✓" 
end   
end
...
redis:set(bita..'SET:ID:USER'..msg.chat_id_,ID_USER)  
redis:setex(bita.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
...
local ID_USER = MsgText[2]
redis:set(bita..'SET:ID:USER:NUM'..msg.chat_id_,ID_USER)  
redis:setex(bita.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
sendMsg(msg.chat_id_,msg.id_,'*• ارسل لي عدد النقاط الذي تريده*')
end
if not redis:get(bita..'lock_geams'..msg.chat_id_) and msg.GroupActive then
if MsgText[1] == 'اسئله' or MsgText[1] == 'ختيارات' or MsgText[1] == 'بدء الاسئله' then   
redis:set(bita.."GAME:S"..msg.chat_id_,true) 
t1 = [[
...
redis:set(bita.."GAME:CHER"..msg.chat_id_,'النيل') 
elseif SENDTEXT:find('14') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'14') 
elseif SENDTEXT:find('الفم') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'الفم') 
elseif SENDTEXT:find('11') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'11') 
elseif SENDTEXT:find('30') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'30') 
elseif SENDTEXT:find('بوتين') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'باريس') 
elseif SENDTEXT:find('10') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'10') 
elseif SENDTEXT:find('النمل') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'سحاب') 
elseif SENDTEXT:find('الاسم') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'الاسم') 
elseif SENDTEXT:find('ذهب') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'العزائم') 
elseif SENDTEXT:find('انسات') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'اسيا') 
elseif SENDTEXT:find('الاسد') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'الاسد') 
elseif SENDTEXT:find('6') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'6') 
elseif SENDTEXT:find('مهر') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'مهر') 
elseif SENDTEXT:find('الدلفين') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'الزئبق') 
elseif SENDTEXT:find('لندن') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'لندن') 
elseif SENDTEXT:find('الانسان') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'خديجه') 
end
...
redis:set(bita..':Set_alii:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(bita..':Set_Amthlh:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(bita..':Set_Hzorh:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(bita..':Set_twet:'..msg.chat_id_,name)
...
Num = math.random(1,6)
redis:set(bita.."GAMES"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
redis:setex(bita.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
if MsgText[1] == 'خمن' or MsgText[1] == 'تخمين' then   
Num = math.random(1,20)
redis:set(bita.."GAMES:NUM"..msg.chat_id_,Num) 
TEST = '*\n• اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..'• ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..'• سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ \n• *'
sendMsg(msg.chat_id_,msg.id_,TEST)
redis:setex(bita.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
if (MsgText[1] == 'اسرع' or MsgText[1] == 'الاسرع') then
local NUM = math.random(10,1000)
redis:set(bita..':NUM_SET:'..msg.chat_id_,(NUM * 3))
...
redis:set(bita..':Set_Smile:'..msg.chat_id_,Emoji)
if tonumber(redis:get(bita..':Set_Smile:'..msg.chat_id_)) == tonumber(redis:get(bita..':NUM_SET:'..msg.chat_id_)) then
return 'اول من يكتب هذا العدد يفوز ↤︎`'..(redis:get(bita..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️اول من يكتب هذه السمايل يفوز ↤︎    `'..(redis:get(bita..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
name = katu[math.random(#katu)]
redis:set(bita..':Set_Arg:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(bita..':Set_Name_Meant:'..msg.chat_id_,name)
...
redis:set(bita.."GAME:CHER"..msg.chat_id_,'فهمت') 
elseif SENDTEXT:find('شجاع') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'شجاع') 
elseif SENDTEXT:find('حي') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'حي') 
elseif SENDTEXT:find('نشيط') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'نشيط') 
elseif SENDTEXT:find('مو زين') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'مو زين') 
elseif SENDTEXT:find('مو عطشان') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'مو عطشان') 
elseif SENDTEXT:find('حاره') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'حاره') 
elseif SENDTEXT:find('مو خايف') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'مو خايف') 
elseif SENDTEXT:find('خلف') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'خلف') 
elseif SENDTEXT:find('وفي') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'وفي') 
elseif SENDTEXT:find('قزم') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'قزم') 
elseif SENDTEXT:find('لين') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'لين') 
elseif SENDTEXT:find('خشن') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'خشن') 
elseif SENDTEXT:find('عاقل') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'عاقل') 
elseif SENDTEXT:find('ذكي') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'ذكي') 
elseif SENDTEXT:find('مو ظلمه') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'مو ظلمه') 
elseif SENDTEXT:find('ممنوع') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'مو ممنوع') 
elseif SENDTEXT:find('اسمعك') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'اسمعك') 
elseif SENDTEXT:find('روح') then
redis:set(bita.."GAME:CHER"..msg.chat_id_,'روح') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
redis:decrby(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_,MsgText[2])  
redis:incrby(bita..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_,Total_Point)  
return "• تم خصم {* "..MsgText[2].." *} من نقاطك\n• تم زياده {* "..Total_Point.."* } من الرسائل \n• اصبحت رسائلك { *"..redis:get(bita..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_).."* } رساله\n• "
end
end
if MsgText[1] == "الالعاب" or MsgText[1] == "اللعبه" or MsgText[1] == "اللعبة" then
return [[ 
• الالعاب لبوت []]..redis:get(bita..':NameBot:')..[[]   ،  🎖
...
redis:del(bita..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) 
redis:del(bita..':List_Rolet:'..msg.chat_id_)  
redis:setex(bita..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_,3600,true)  
return '*• * حسناً لنلعب , ارسل عدد اللاعبين للروليت .'
end
if MsgText[1] == 'نعم' and redis:get(bita..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_) then
local list = redis:smembers(bita..':List_Rolet:'..msg.chat_id_) 
if #list == 1 then 
...
redis:incrby(bita..':User_Points:'..msg.chat_id_..data.id_,5)
end,nil)
redis:del(bita..':List_Rolet:'..msg.chat_id_) 
redis:del(bita..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_)
...
if msg.text and not redis:get(bita..'lock_geams'..msg.chat_id_) then
if msg.text == redis:get(bita..':Set_alii:'..msg.chat_id_) then -- // المختلف
redis:incrby(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(bita..':Set_alii:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• احسنت اجابتك صحيحه   \n*   \n')
end

if msg.text == redis:get(bita..':Set_Amthlh:'..msg.chat_id_) then -- // امثله
redis:incrby(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(bita..':Set_Amthlh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• احسنت اجابتك صحيحه   \n*   \n')
end

if msg.text == redis:get(bita..':Set_Hzorh:'..msg.chat_id_) then -- // حزوره
redis:incrby(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(bita..':Set_Hzorh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• احسنت اجابتك صحيحه   \n*   \n')
end


if msg.text == redis:get(bita..':Set_Smile:'..msg.chat_id_) then --//  الاسرع
redis:incrby(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(bita..':Set_Smile:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• احسنت اجابتك صحيحه \n*   \n')
end 
if msg.text == redis:get(bita..':Set_alii:'..msg.chat_id_) then -- // المختلف
redis:incrby(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
...
if msg.text == redis:get(bita..':Set_Arg:'..msg.chat_id_) then -- // الترتيب
redis:incrby(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(bita..':Set_Arg:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• احسنت اجابتك صحيحه   \n*   \n')
end 
if msg.text == redis:get(bita..':Set_Name_Meant:'..msg.chat_id_) then --// المعاني
redis:incrby(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(bita..':Set_Name_Meant:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• احسنت اجابتك صحيحه \n*   \n')
end 
if msg.text:match("^(%d+)$") and redis:get(bita..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_) then  --// استقبال اللعبه الدمبله
if msg.text == "1" then
Text = "*• * لا استطيع بدء اللعبه بلاعب واحد فقط\n"
else
redis:set(bita..":Number_Add:"..msg.chat_id_..msg.sender_user_id_,msg.text)  
Text = '• تم بدء تسجيل اللسته \n• يرجى ارسال المعرفات \n• الفائز يحصل على (5) مجوهره\n• عدد الاعبين المطلوبه { *'..msg.text..'* } لاعب \n'
end
redis:del(bita..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_)  
return sendMsg(msg.chat_id_,msg.id_,Text)    
end
if msg.text:match('^(@[%a%d_]+)$') and redis:get(bita..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) then    --// استقبال الاسماء
if redis:sismember(bita..':List_Rolet:'..msg.chat_id_,msg.text) then
return sendMsg(msg.chat_id_,msg.id_,'*• * المعرف {['..msg.text..']} موجود اساساً' )
end
redis:sadd(bita..':List_Rolet:'..msg.chat_id_,msg.text)
local CountAdd = redis:get(bita..":Number_Add:"..msg.chat_id_..msg.sender_user_id_)
local CountAll = redis:scard(bita..':List_Rolet:'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
redis:del(bita..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) 
redis:setex(bita..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_,1400,true)  
...
if redis:get(bita.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_) then 
...
redis:del(bita.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = redis:get(bita..'SET:ID:USER'..msg.chat_id_)  
sendMsg(msg.chat_id_,msg.id_,"\n• *│روح خالي تم اضافة له { "..msg.text.." }* رساله")
redis:incrby(bita..'msgs:'..GET_IDUSER..':'..msg.chat_id_,msg.text)  
end
redis:del(bita.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
end
if redis:get(bita.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_) then 
if msg.text:match("^(%d+)$") then
if tonumber(msg.text:match("^(%d+)$")) > 99999999990 then
sendMsg(msg.chat_id_,msg.id_,"*• لا تستطيع اضافة اكثر من 99999999990 نقطه\n*")   
redis:del(bita.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = redis:get(bita..'SET:ID:USER:NUM'..msg.chat_id_)  
sendMsg(msg.chat_id_,msg.id_,"\n• *روح خالي تم  اضافة له { "..msg.text.." }* نقطه")
redis:incrby(bita..':User_Points:'..msg.chat_id_..GET_IDUSER,msg.text)  
end
redis:del(bita.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
end
if redis:get(bita.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
if tonumber(NUM) > 6 then
sendMsg(msg.chat_id_,msg.id_,"*• عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخره*\n")   
return false  end 
local GETNUM = redis:get(bita.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(bita.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
sendMsg(msg.chat_id_,msg.id_,'*• مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n• لقد حصلت على { 3 }من نقاط يمكنك استبدالها برسائل *')   
redis:incrby(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_,3)  
...
if (msg.text == redis:get(bita.."GAME:CHER"..msg.chat_id_)) and redis:get(bita.."GAME:S"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'• اجابتك صحيحه ذكي وربي')     
redis:incrby(bita..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(bita.."GAME:S"..msg.chat_id_)
redis:del(bita.."GAME:CHER"..msg.chat_id_)
...
if redis:get(bita.."GAME:S"..msg.chat_id_) then  
...
if redis:get(bita.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
if tonumber(NUM) > 20 then
sendMsg(msg.chat_id_,msg.id_,"*• عذراً لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 } *\n")
return false  end 
local GETNUM = redis:get(bita.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(bita..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
redis:del(bita.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
redis:incrby(bita..':User_Points:'..msg.chat_id_..data.id_,5)
sendMsg(msg.chat_id_,msg.id_,'*• مبروك فزت معنا وخمنت الرقم الصحيح\n• تم اضافة { 5 } من النقاط *\n')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:incrby(bita..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(redis:get(bita..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
redis:del(bita..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
redis:del(bita.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if redis:get(bita.."chencher"..msg.sender_user_id_) then 
if redis:get(bita.."chencher"..msg.sender_user_id_) ~= data.first_name_ then 
tahan = '['..(redis:get(bita.."chencher"..msg.sender_user_id_) or '')..']'
taham = '['..data.first_name_..']'
sendMsg(msg.chat_id_,msg.id_,taha[math.random(#taha)])
end  
end
redis:set(bita.."chencher"..msg.sender_user_id_, data.first_name_) 
end,nil) 
end
end
return {
