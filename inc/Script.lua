...
if not msg.Rank then end
if not MsgText[2] and msg.reply_id then
if redis:get(bita..'lock:karaa:'..msg.chat_id_) == 'off' then
GetMsgInfo(msg.chat_id_,msg.reply_id,action_by_reply,{msg=msg,cmd="zkzk"})
end
end
if redis:get(bita..'lock:karaa:'..msg.chat_id_) == 'on' then  
...
local keyboard = {}
keyboard.inline_keyboard = {
{{text = 'مطور السورس ⚡.',url="https://t.me/xb_0b"},
{text = 'مطور السورس ⚡',url="https://t.me/UU_Fs"}},
{{text = '- قناة السورس ⚛ .',url="https://t.me/sourcehill"}},
{{text = '- قناة البوت 🤖 .',url="https://t.me/SourceHacker"},
{text = '- للتواصل 💬 .',url="https://t.me/Abazaxbot"}},
}   
send_inline(msg.chat_id_,  "اهلاً بك في سورس هيل🔥" ,keyboard,'html')
end
